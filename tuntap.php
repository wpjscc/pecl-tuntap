...
run_command('ifconfig ' . $Interface . ' inet 10.10.10.1/24 10.10.10.1');
// run_command('route -n add -net 10.10.10.0 -netmask 255.255.255.0 10.10.10.1');
...
while (!feof($TAP)) {
  ...
  echo date('H:i:s.u '), 'Read ', strlen($Data), ' bytes', $br, "\n";
